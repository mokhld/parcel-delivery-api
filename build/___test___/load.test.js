...
describe('load', function () {
    describe('get load route', function () {
        describe('get all loads', function () {
            it('should return a 200', function () { return __awaiter(void 0, void 0, void 0, function () {
                var _a, status, body;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, (0, supertest_1.default)(app).get("/loads")];
                        case 1:
        ...
        describe('given loaded truck id does not exist', function () {
            it('should return a 404', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            truckId = 'test-123';
                            return [4 /*yield*/, (0, supertest_1.default)(app).get("/loads/".concat(truckId)).expect(404)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        describe('given loaded truck id does exist', function () {
            it('should return a 200 status and the load details', function () { return __awaiter(void 0, void 0, void 0, function () {
                var truckId, _a, status, body;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            truckId = 6;
                            return [4 /*yield*/, (0, supertest_1.default)(app).get("/loads/".concat(truckId))];
                        case 1:
                            _a = _b.sent(), status = _a.status, body = _a.body;
                            expect(status).toBe(200);
                            expect(body.status).toBe('success');
        ...
        describe('Load given truckId/parcelId which does not exist', function () {
        ...
        describe('Unload the truck that does not exist', function () {
